...
ysc = znorm( np.convolve( ys, ys, mode='same') )
...
plot1 = ax.plot(taus, yss, label='smoothed', color='red', marker=".", linewidth=3, markersize=6, alpha=1.0)[0]
plot2 = ax.plot(t, ys, label='signal', color='blue', marker=".", linewidth=1, markersize=2, alpha=0.2)[0]
plot3 = ax.plot(taus, yssc, label='smoothed-cor', color='red', marker=".", linewidth=2, markersize=4, alpha=1.0)[0]
