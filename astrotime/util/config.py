...
class ConfigContext(initialize):
    ...
    def __init__(self, rank: int, ccustom: Dict = None ):
    ...
    def initialize(cls, cname: str, configuration: Dict[str,Any], args: Namespace = default_args, ccustom: Dict[str,Any]=None,  rank: int = 0 ):
        ...
        return cls.activate_global(ccustom,rank)
    ...
    @classmethod
    def activate_global(cls, ccustom: Dict, rank: int = 0 ) -> 'ConfigContext':
        cc = ConfigContext( rank, ccustom )
        cc.activate()
        return cc
